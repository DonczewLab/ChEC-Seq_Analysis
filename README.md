...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.15232549.svg)](https://doi.org/10.5281/zenodo.15232549)
...
9A. Download version controlled workflow
```
wget https://github.com/RD-Cobre-Help/ChEC-Seq_Analysis/releases/download/v1.0.3/ChEC-Seq_Analysis-1.0.3.tar.gz
refs/tags/v1.0.3.tar.gz
tar -xzf ChEC-Seq_Analysis-1.0.3.tar.gz
rm ChEC-Seq_Analysis-1.0.3.tar.gz
cd ChEC-Seq_Analysis-1.0.3
```
9B. Load modules
```
module purge
